    ...
    methods: {
        ...
        calcCorrelation (data, r, x, y, rectScale, holderScale, y1, y2, HighlightPath, r_color) {
            ...
            for (let i in pieData) {
                innerArc.push({
                    data: pieData[i].data,
                    d: arc().innerRadius(0).outerRadius(r - 2)(pieData[i]),
                    dOut: arc().innerRadius(r - 2).outerRadius(r + 3)(pieData[i]),
                    dLegend: arc().innerRadius(0).outerRadius(this.cvHeight * 0.15 - 20)(pieData[i]),
                    dLegendOut: arc().innerRadius(this.cvHeight * 0.15 - 20).outerRadius(this.cvHeight * 0.15 - 10)(pieData[i]),
