 ...
 * @Description: 
 * @Author: Qing Shi
 * @Date: 2023-11-22 21:47:01
 * @LastEditors: Qing Shi
 * @LastEditTime: 2023-11-22 21:47:02
-->
<!--
 * @Description: 
 * @Author: Qing Shi
 ...
 * @LastEditors: Qing Shi
 * @LastEditTime: 2023-11-22 21:35:18
-->
<!--
 * @Description: 
 * @Author: Qing Shi
    ...
    <div style="height: 100%">
        <div class="frameworkTitle">
            ...
            <span class="title" style="float: left;">
                ...
                &nbsp; <span style="position: relative; top: 0px; font-weight: 600;">Mechanisms Analysis</span>
            </span>
                    ...
                    <g :transform="translate(groupWidth / 8, groupWidth / 8 + 15, 0)">
                        ...
                        <g :transform="translate(0, 0, 0)">
                            ...
                            <circle x="0" y="0" :r="(groupWidth / 8 - 48 - 15) * 2 / 3 + 15" fill="none" stroke="#7F7F7F"
                                stroke-dasharray="5.5"></circle>
                            <circle x="0" y="0" :r="(groupWidth / 8 - 48 - 15) * 1 / 3 + 15" fill="none" stroke="#7F7F7F"
                                stroke-dasharray="5.5"></circle>
                        ...
                        <path v-for="(t_item, t_i) in item['projectLine']" :key="'pL' + t_i" :d="t_item.d" :fill="'none'"
                            ...
                            stroke-width=".8" :opacity="filterValue == t_item.id ? 1 : 1"></path>
                    </g>
    ...
    methods: {
        ...
        dataProcess (data) {
            ...
            for (let i in data) {
                ...
                group_set.push(parseInt(data[i].Group));
            ...
            for (let i = 0; i < m1.length; i++) {
                ...
                a[aa].v++;
                if (typeof a[aa].stacked_data[group_set[i]] == 'undefined') a[aa].stacked_data[group_set[i]] = 0;
                a[aa].stacked_data[group_set[i]]++;
                r[rr].v++;
                if (typeof r[rr].stacked_data[group_set[i]] == 'undefined') r[rr].stacked_data[group_set[i]] = 0;
                r[rr].stacked_data[group_set[i]]++;
                p[pp].v++;
                if (typeof p[pp].stacked_data[group_set[i]] == 'undefined') p[pp].stacked_data[group_set[i]] = 0;
                p[pp].stacked_data[group_set[i]]++;
                m[mm].v++;
                if (typeof m[mm].stacked_data[group_set[i]] == 'undefined') m[mm].stacked_data[group_set[i]] = 0;
                m[mm].stacked_data[group_set[i]]++;
            ...
            for (let i in a) {
                ...
                let w = a[i].w;
                sta_cnt = 0;
                for (let j in a[i].stacked_data) {
                    a_sta_data.push({
                        x: x,
                        y: yAScale(y - sta_cnt),
                        w:w,
                        h: yAScale(0) - yAScale(a[i].stacked_data[j]),
                        type: j
                    })
                    sta_cnt += a[i].stacked_data[j];
                }
            }
            sta_cnt = 0;
            for (let i in r) {
                ...
                let w = r[i].w;
                sta_cnt = 0;
                for (let j in r[i].stacked_data) {
                    r_sta_data.push({
                        x: x,
                        y: yRScale(y - sta_cnt),
                        w:w,
                        h: yRScale(0) - yRScale(r[i].stacked_data[j]),
                        type: j
                    })
                    sta_cnt += (r[i].stacked_data[j]);
                }
            }
            sta_cnt = 0;
            for (let i in p) {
                ...
                let w = p[i].w;
                sta_cnt = 0;
                for (let j in p[i].stacked_data) {
                    p_sta_data.push({
                        x: x,
                        y: yPScale(y - sta_cnt),
                        w: w,
                        h: yPScale(0) - yPScale(p[i].stacked_data[j]),
                        type: j
                    })
                    sta_cnt += (p[i].stacked_data[j]);
                }
            }
            sta_cnt = 0;
            for (let i in m) {
                ...
                let w = m[i].w;
                sta_cnt = 0;
                for (let j in m[i].stacked_data) {
                    m_sta_data.push({
                        x: x,
                        y: yMScale(y - sta_cnt),
                        w: w,
                        h: yMScale(0) - yMScale(m[i].stacked_data[j]),
                        type: j
                    })
                    sta_cnt += (m[i].stacked_data[j]);
                }
            }
            for (let i in group) {
