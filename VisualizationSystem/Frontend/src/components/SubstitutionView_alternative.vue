 ...
 * @LastEditTime: 2023-07-05 18:17:06
-->
<!--
 * @Description: 
 * @Author: Qing Shi
                    ...
                    <span>
                        <p style="cursor:pointer; margin-top: 10px; width: 30px; height: 30px;" @click="groupSelectBtn">
                            <svg style="margin-left: -3px;" v-if="groupSelect == 0" t="1679856784187" class="icon"
                                viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6521"
                                width="32" height="32">
                                <path
                                    ...
                                    fill="#534f4f" p-id="6522"></path>
                            </svg>
                            <svg style="margin-left: -3px;" v-else t="1679856854171" class="icon" viewBox="0 0 1024 1024"
                                version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6908" id="mx_n_1679856854172"
                                width="32" height="32">
                                <path
                                    d="M836.54 429.526667l-498.833333-288-91.946667-53.086667c-10-5.78-18.553333-2.1-21.76-0.246667A21.333333 21.333333 0 0 0 213.333333 106.666667v682.666666a21.333333 21.333333 0 0 0 36.113334 15.386667l154.666666-148.586667 130.38 225.826667A53.333333 53.333333 0 0 0 607.333333 901.486667l129.333334-74.666667a53.333333 53.333333 0 0 0 19.526666-72.86L625.8 528.133333l206-59.64a21.333333 21.333333 0 0 0 4.733333-38.966666z"
                                    fill="#534f4f" p-id="6909"></path>
                            </svg>
                        </p>

                        <p style="cursor:pointer; margin-top: 10px;width: 30px; height: 30px;" @click="projectSelectBtn">
                            <svg v-if="projectSelectSta == 0" t="1679354394057" class="icon" viewBox="0 0 1024 1024"
                                version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4906" width="25" height="25">
                                <path
                                    d="M512 896C192 896 12.8 546.133333 4.266667 529.066667c-4.266667-12.8-4.266667-25.6 0-38.4C12.8 477.866667 192 128 512 128s499.2 349.866667 507.733333 366.933333c4.266667 12.8 4.266667 25.6 0 38.4-8.533333 12.8-187.733333 362.666667-507.733333 362.666667z m-422.4-384c38.4 68.266667 192 298.666667 422.4 298.666667s379.733333-230.4 422.4-298.666667c-38.4-68.266667-192-298.666667-422.4-298.666667s-379.733333 230.4-422.4 298.666667z"
                                    p-id="4907" fill="#5C5C66"></path>
                                <path
                                    d="M512 682.666667c-93.866667 0-170.666667-76.8-170.666667-170.666667s76.8-170.666667 170.666667-170.666667 170.666667 76.8 170.666667 170.666667-76.8 170.666667-170.666667 170.666667z m0-256c-46.933333 0-85.333333 38.4-85.333333 85.333333s38.4 85.333333 85.333333 85.333333 85.333333-38.4 85.333333-85.333333-38.4-85.333333-85.333333-85.333333z"
                                    p-id="4908" fill="#5C5C66"></path>
                            </svg>
                            <svg v-else t="1679354463560" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" p-id="5146" width="25" height="25">
                                <path
                                    d="M379.428571 512a128 128 0 1 0 256 0 128 128 0 1 0-256 0z m624.228572-29.485714C895.314286 254.285714 731.542857 139.428571 512 139.428571c-219.657143 0-383.314286 114.857143-491.657143 343.2a68.914286 68.914286 0 0 0 0 58.857143C128.685714 769.714286 292.457143 884.631429 512 884.631429c219.657143 0 383.314286-114.857143 491.657143-343.2 8.8-18.514286 8.8-40 0-58.857143zM507.428571 713.142857c-111.085714 0-201.142857-90.057143-201.142857-201.142857s90.057143-201.142857 201.142857-201.142857 201.142857 90.057143 201.142858 201.142857-90.057143 201.142857-201.142858 201.142857z"
                        ...
                        <p style="cursor:pointer; margin-top: 10px;width: 30px; height: 30px;" @click="zoomBtn(2)">
                            <svg style="margin-left: -3px;" t="1679896989202" class="icon" viewBox="0 0 1024 1024"
                                ...
                                <path
                                    d="M170.666667 192V341.333333l170.666666-170.666666H192c-12.8 0-21.333333 8.533333-21.333333 21.333333zM682.666667 170.666667l170.666666 170.666666V192c0-12.8-8.533333-21.333333-21.333333-21.333333H682.666667z m170.666666 661.333333V682.666667l-170.666666 170.666666h149.333333c12.8 0 21.333333-8.533333 21.333333-21.333333zM192 853.333333H341.333333l-170.666666-170.666666v149.333333c0 12.8 8.533333 21.333333 21.333333 21.333333zM810.666667 512c0-166.4-132.266667-298.666667-298.666667-298.666667s-298.666667 132.266667-298.666667 298.666667 132.266667 298.666667 298.666667 298.666667 298.666667-132.266667 298.666667-298.666667z m-298.666667 213.333333c-119.466667 0-213.333333-93.866667-213.333333-213.333333s93.866667-213.333333 213.333333-213.333333 213.333333 93.866667 213.333333 213.333333-93.866667 213.333333-213.333333 213.333333z"
                                    p-id="3387" fill="#534f4f"></path>
                            </svg>
                        </p>
                        <p style="cursor:pointer; margin-top: 10px;width: 30px; height: 30px;" @click="zoomBtn(3)">
                            <svg t="1678908588773" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" p-id="2763" width="25" height="25">
                                <path
                                    d="M999.15093333 997.63321482H648.6546963v-77.6722963h272.82394073V648.41197037h77.6722963zM99.85137778 372.67531852h-77.6722963V23.63543703h350.49623704v77.6722963H99.85137778z"
                                    p-id="2764" fill="#534f4f"></path>
                                <path
                                    d="M53.30504059 108.18294518l54.92159526-54.92159526 353.64681956 353.64681956-54.92159526 54.92159527zM562.35349333 617.21440711l54.92159526-54.92280889L991.51720297 936.53492622l-54.92159527 54.92159526zM999.15093333 374.13167408h-77.6722963V101.30773333H650.11105185v-77.6722963h349.03988148zM371.21896297 997.63321482H22.17908148V647.07697778h77.6722963v272.82394074H371.21896297z"
                                    p-id="2765" fill="#534f4f"></path>
                                <path
                                    d="M60.58196385 908.09472948L406.73826133 562.23213037l54.8985363 54.94586785L115.48292741 963.04059733zM562.38019318 406.71277511l367.72006874-367.72128236 54.9228089 54.92280888L617.30178845 461.63437037z"
                                    p-id="2766" fill="#534f4f"></path>
                            </svg>
                        </p>
                        <p style="cursor:pointer; margin-top: 10px;width: 30px; height: 30px;" @click="zoomBtn(1)">
                            <svg t="1679856196972" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" p-id="5176" width="25" height="25">
                                <path
                    ...
                    <svg width="100%" height="100%" v-show="showTag">
                        <g :transform="translate(elWidth / 2, (distributionHeight) / 2, 0)">
                            ...
                            <g :transform="translate(0, 0, 0)">
                                ...
                                <path v-for="(arc_item, arc_i) in outerArc" :key="'arc' + arc_i" :d="arc_item.d"
                                    stroke="none" :id="'GroupArc' + arc_item.group" :class="'groupArc'"
                                    :fill="arc_i == groupTag ? 'none' : colormap[arc_i]"
                                    @mouseenter="mouseoverGroup(arc_item.group)" @mouseout="mouseoutGroup()"
                                    @click="clickGroup(arc_item.group)"></path>

                                <path v-for="(arc_item, arc_i) in groupArc" :key="'arc' + arc_i" :d="arc_item.arc"
                                    :id="'GroupArc' + arc_item.group"
                                    ...
                                    stroke-width="1" @mouseenter="mouseoverProject($event, arc_item.project)"
                                    @mouseout="mouseoutProject()" @click="clickProject(arc_item.project)"></path>
                            ...
                            <g clip-path="url(#clipPathNetwork)">
                                ...
                                <circle v-for="(c_item, c_i) in scatterData" :key="'gc' + c_i"
                                    :id="'pro_cir' + c_item.id_cnt" :class="'all_pro_cir'" :cx="c_item.cx" :cy="c_item.cy"
                                    :r="5"
                                    :fill="(selectGroup == -1 && ProjectClickSta == 0) ? colormap[c_item.group] : '#c0c0c0'"
                                    :opacity="(selectGroup == -1 && ProjectClickSta == 0) ? 1 : 0.3"
                                    @mouseenter="ProjectClickSta == 0 ? mouseoverProject($event, c_item.data) : null"
                                    @mouseout="mouseoutProject" @click="clickProject(c_item.data)">
                                </circle>
                            </g>
                            <g clip-path="url(#clipPathNetwork)">

                                <circle v-for="(c_item, c_i) in projectSelect" :key="'gc' + c_i" :cx="c_item.x"
                                    :cy="c_item.y" :r="c_item.sel == 1 ? 8 : 5" :stroke-width="c_item.sel == 1 ? 3 : 0"
                                    :stroke="c_item.sel == 1 ? 'black' : 'none'" :fill="colormap[c_item.group]" :opacity="1"
                                    @mouseenter="mouseoverProject($event, c_item.data)" @mouseout="mouseoutProject">
                                </circle>
                            </g>
...
export default {
    ...
    methods: {
        ...
        calcScatterRaw (pre_data, powIndex, namespace) {
            let data = [];
        ...
        //     if (powIndex == 2) {
        //         let center = { x: 0, y: 0 };
        //         for (let i in t_scatterData) {
        //             center.x += t_scatterData[i].cx;
        //             center.y += t_scatterData[i].cy;
        //         }
        //         center.x /= t_scatterData.length;
        //         center.y /= t_scatterData.length;
        //         centerCir = center;
        //         // center.x = scatterData[0].x;
        //         // center.y = scatterData[0].y;
        //         let maxLen = 0;
        //         for (let i in t_scatterData) {
        //             let len = Math.sqrt((t_scatterData[i].cx - center.x) * (t_scatterData[i].cx - center.x) + (t_scatterData[i].cy - center.y) * (t_scatterData[i].cy - center.y));
        //             // let lenn = Math.pow(len, 1 / 2)
        ...
        //             let ax, ay;
        //             if (len != 0) {
        //                 ax = (cx - centerCir.x) * zoomLenScale(len) / len;
        //                 ay = (cy - centerCir.y) * zoomLenScale(len) / len;
        //             } else {
        //                 ax = cx - centerCir.x;
        //                 ay = cy - centerCir.y;
        //             }
        ...
        calcScatter (pre_data, powIndex, namespace) {
            ...
            for (let i in pre_data) {
                ...
                // console.log(tp);
                allScatterData.push(tp);
                // console.log(allScatterData)
                // console.log(namespaceX);
                if (namespace.length == 0 || namespaceX[pre_data[i]['Project Name']] == 1) {
                    scatterData.push(tp);
                }
    ...
    mounted () {
        ...
        dataStore.$subscribe((mutations, state) => {
            if (dataStore.allData.tag == 1) {
                ...
                [this.scatterData, this.innerArea] = this.calcScatter(dataStore.allData.cpData.data, this.zoomTag, this.projectSelect);
