 ...
 * @LastEditTime: 2023-03-27 14:14:26
-->
<template>
                ...
                <span>
                                                                            ...
                                                                            <p style="cursor:pointer; margin-top: 10px;width: 30px; height: 30px;" @click="projectSelectBtn">
                                                                                ...
                                                                                <p style="cursor:pointer; margin-top: 10px;width: 30px; height: 30px;" @click="zoomBtn(2)">
                                                                                    ...
                                                                                    t="1679896989202" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3386" width="32" height="32"><path d="M170.666667 192V341.333333l170.666666-170.666666H192c-12.8 0-21.333333 8.533333-21.333333 21.333333zM682.666667 170.666667l170.666666 170.666666V192c0-12.8-8.533333-21.333333-21.333333-21.333333H682.666667z m170.666666 661.333333V682.666667l-170.666666 170.666666h149.333333c12.8 0 21.333333-8.533333 21.333333-21.333333zM192 853.333333H341.333333l-170.666666-170.666666v149.333333c0 12.8 8.533333 21.333333 21.333333 21.333333zM810.666667 512c0-166.4-132.266667-298.666667-298.666667-298.666667s-298.666667 132.266667-298.666667 298.666667 132.266667 298.666667 298.666667 298.666667 298.666667-132.266667 298.666667-298.666667z m-298.666667 213.333333c-119.466667 0-213.333333-93.866667-213.333333-213.333333s93.866667-213.333333 213.333333-213.333333 213.333333 93.866667 213.333333 213.333333-93.866667 213.333333-213.333333 213.333333z" p-id="3387" fill="#534f4f"></path></svg>
                                                                                </p>
                                                                                <p style="cursor:pointer; margin-top: 10px;width: 30px; height: 30px;" @click="zoomBtn(3)">
                                                                                    <svg t="1678908588773" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2763" width="25" height="25"><path d="M999.15093333 997.63321482H648.6546963v-77.6722963h272.82394073V648.41197037h77.6722963zM99.85137778 372.67531852h-77.6722963V23.63543703h350.49623704v77.6722963H99.85137778z" p-id="2764" fill="#534f4f"></path><path d="M53.30504059 108.18294518l54.92159526-54.92159526 353.64681956 353.64681956-54.92159526 54.92159527zM562.35349333 617.21440711l54.92159526-54.92280889L991.51720297 936.53492622l-54.92159527 54.92159526zM999.15093333 374.13167408h-77.6722963V101.30773333H650.11105185v-77.6722963h349.03988148zM371.21896297 997.63321482H22.17908148V647.07697778h77.6722963v272.82394074H371.21896297z" p-id="2765" fill="#534f4f"></path><path d="M60.58196385 908.09472948L406.73826133 562.23213037l54.8985363 54.94586785L115.48292741 963.04059733zM562.38019318 406.71277511l367.72006874-367.72128236 54.9228089 54.92280888L617.30178845 461.63437037z" p-id="2766" fill="#534f4f"></path></svg>
                                                                                </p>
                                                                                <p style="cursor:pointer; margin-top: 10px;width: 30px; height: 30px;" @click="zoomBtn(1)">
                                                                                <svg t="1679856196972" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5176" width="25" height="25"><path d="M86.6 669.4c0 19.9 16.1 36 36 36h145.1L74.5 898.5c-14.1 14.1-14.1 36.9 0 50.9 7 7 16.2 10.5 25.5 10.5s18.4-3.5 25.5-10.5l193.1-193.1v145.1c0 19.9 16.1 36 36 36s36-16.1 36-36v-268h-268c-19.9 0-36 16.1-36 36zM949.5 74.5c-14.1-14.1-36.9-14.1-50.9 0L705.4 267.7V122.6c0-19.9-16.1-36-36-36s-36 16.1-36 36v268h268c19.9 0 36-16.1 36-36s-16.1-36-36-36H756.3l193.1-193.1c14.1-14.1 14.1-36.9 0.1-51z" p-id="5177" fill="534f4f"></path>
...
export default {
    ...
    methods: {
        ...
        calcProjFlow(data, sel_id) {
            ...
            let wScale = scaleLinear(extentData, [1, 4]);
            let pos_data = {};
        ...
        calcScatter(pre_data, powIndex, namespace) {
            ...
            if (powIndex == 2) {
                ...
                // console.log(maxLen);
                let lenScale = scaleLinear([0, maxLen], [0, 0.63 * this.distributionHeight / 2]);
                ...
                //     if (len != 0) {
                //         let lenn = Math.pow(len, 1 / 2)
                //         console.log(center, lenScale(len), .63 * this.distributionHeight / 2, len, namespace)
                //         // console.log(lenScale(lenn), scatterData[i].x - center.x)
            ...
            for (let i in pre_data) {
                ...
                let sx = (parseFloat(pre_data[i].Holder / (pre_data[i].Holder + pre_data[i].Seller + pre_data[i].Buyer)) + parseFloat(pre_data[i].Buyer) * 2 / (pre_data[i].Holder + pre_data[i].Seller + pre_data[i].Buyer)) / Math.sqrt(3);
                let sy = parseFloat(pre_data[i].Holder / (pre_data[i].Holder + pre_data[i].Seller + pre_data[i].Buyer));
                let cx = (Math.sin(((240) * Math.PI) / 180) * (this.distributionHeight * .63 / 2)) + sx * t_h;
                let cy = (-Math.cos(((240) * Math.PI) / 180) * (this.distributionHeight * .63 / 2)) - sy * t_h;
                if (powIndex == 2) {
